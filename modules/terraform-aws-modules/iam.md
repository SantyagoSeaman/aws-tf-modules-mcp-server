...
| `inline_policy_permissions` | `map(object)` | `null` | Inline policy statements (actions, resources, effect, principals, conditions) — fields: `sid`, `actions`, `not_actions`, `effect`, `resources`, `not_resources`, `principals`, `not_principals`, … (8 shown; call get_module with sections=["inputs","outputs"] for the complete list) |
...
| `permissions` | `map(object)` | `null` | Custom policy statements (actions, resources, effect, principals, conditions) — fields: `sid`, `actions`, `not_actions`, `effect`, `resources`, `not_resources`, `principals`, `not_principals`, … (8 shown; call get_module with sections=["inputs","outputs"] for the complete list) |
...
| `trust_policy_permissions` | `map(object)` | `null` | Custom trust policy statements (actions, principals, conditions) — fields: `sid`, `actions`, `not_actions`, `effect`, `resources`, `not_resources`, `principals`, `not_principals`, … (8 shown; call get_module with sections=["inputs","outputs"] for the complete list) |
