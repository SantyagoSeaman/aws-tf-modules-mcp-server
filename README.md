...
**Total**: 761 tests (integration + e2e; 738 passing, 23 skip — 6 opt-in live tests unless `RUN_REGISTRY_BENCHMARK=1`, plus 17 docs with no submodule inventory skipped by the schema guard)
